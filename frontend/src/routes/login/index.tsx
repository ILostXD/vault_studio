...
function LoginPage() {
	...
	if (
		authLoading ||
		(!hasCheckedUsers && !connectionError) ||
		isAuthenticated
	) {
		...
		<div className="flex min-h-dvh overflow-y-auto bg-(--bg-0) p-4 focus-within:pb-[45dvh] lg:focus-within:pb-4">
			<div className="my-auto w-full max-w-[500px] mx-auto">
				<motion.div
					...
					className="border border-(--card-border) rounded-[45px] bg-[linear-gradient(180deg,var(--card-gradient-from)_0%,var(--card-gradient-to)_100%)] px-10 py-12"
					style={{
